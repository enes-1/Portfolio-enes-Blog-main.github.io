...
!function () {
	window.SVG3DTagCloud = function (t, e) {
		...
		if (void 0 !== e)
			for (var o in e) e.hasOwnProperty(o) && i.hasOwnProperty(o) && (i[o] = e[o]);
		if (!i.entries.length) return !1;
		var n, r, a, s, l, u, c, d = [], m = !0, f = { x: 0, y: 0 }, p = { x: 0, y: 0, z: 0 }, h = { x: 0, y: 0 }, v = { sx: 0, cx: 0, sy: 0, cy: 0 }, y = Math.PI / 180, g = "http://www.w3.org/2000/svg", w = 1;
		function A() {
